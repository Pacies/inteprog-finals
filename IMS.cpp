...
// FIX: Improved validation function for both username and password
bool isValidInput(const string& input, const string& fieldName) {
    ...
    if (hasOnlyWhitespace) {
        cout << "Invalid " << fieldName << ". " << fieldName << " cannot contain only whitespace." << endl;
        return false;
    }
...
// FIX: Improved input validation for admin user management menu
...
// FIX: Improved integer input validation
...
// FIX: Improved confirmation input validation
...
public:
    ...
    // FIX: Improved addRecord with proper name validation
    void addRecord() {
        if (!isAdmin) {
    ...
    // FIX: Improved editRecord with proper name validation
    void editRecord() {
        if (head == nullptr) {
        ...
        // FIX: Improved quantity input validation
        ...
        if (isAdmin) {
            // FIX: Improved price input validation
            string priceInput;
    ...
    void displayMenu() override {
        ...
        while (running) {
            ...
            if (isAdmin) {
                ...
                // FIX: Improved menu choice validation
                ...
                // FIX: Improved menu choice validation for employee
...
void employeeMenu() {
    ...
    while (empSession) {
        ...
        // FIX: Improved menu choice validation for employee dashboard
...
int main() {
    ...
    while (runProgram) {
        ...
        // Clear input buffer after reading password
        cin.ignore(numeric_limits<streamsize>::max(), '\n');
        ...
        if (!userType.empty()) {
            ...
            // FIX: Improved login retry validation
